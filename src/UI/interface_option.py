...
class OPTION(Interface):
    def __init__(self):
        super().__init__(
            ...
            Label((SCREEN_SIZE[0]/6, SCREEN_SIZE[1]/8 * 5), 'Pick Up:', is_left_center=True), Label((SCREEN_SIZE[0]/3, SCREEN_SIZE[1]/8 * 5), 'V'),
            Label((SCREEN_SIZE[0]/1.65, SCREEN_SIZE[1]/8), 'Pause:', is_left_center=True),  Label((SCREEN_SIZE[0]/1.3, SCREEN_SIZE[1]/8), 'Esc'),
            Label((SCREEN_SIZE[0]/1.65, SCREEN_SIZE[1]/8 * 2), 'Attack:', is_left_center=True),  Label((SCREEN_SIZE[0]/1.3, SCREEN_SIZE[1]/8 * 2), 'Mouse Left / Space'),
