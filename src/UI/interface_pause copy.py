...
class PAUSE(Interface):
    def __init__(self):
        ...
        self.__map = [Image((900, 160), Surface((320, 320))), ImageMap((900, 160))]
        self.__button = [Image((800, 480), Surface((320, 320))),
                         ButtonContinue((720, 400)), ButtonTitle((880, 400)), ButtonRestart((720, 560))]

        self.__profile[0].image.fill((150, 150, 55))
        self.__equipment[0].image.fill((150, 150, 55))
        self.__bag[0].image.fill((150, 150, 55))
        self.__information[0].image.fill((195, 195, 195))
        self.__map[0].image.fill((150, 150, 55))
        self.__map[1].image.fill((0, 0, 0))
        self.__button[0].image.fill((150, 150, 55))
